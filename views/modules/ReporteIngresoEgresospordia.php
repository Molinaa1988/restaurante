			                 ...
			                 <div class="col-md-12">
			                     ...
			                     <div class="panel panel-primary">
			                         <div class="panel-heading">
			                             Reporte ingresos y egresos por dia
			                         </div>
			                                      ...
			                                      <tr>
			                                       ...
			                                       <hr/>
			                                           <div style="font-size: 14px;"align="center">
			                                              <strong>Reporte ingresos y egresos por dia</strong><br>
			                                         </div>
			                                         <hr/>
			                                     </div>
																				 ...
																				 <thead>
																                                    ...
																                                    <?php
																                                                 $neto=0;
																																								 ...
																																								 $respuesta =  controllerReportes::ReporteIngresoEgresospordia($fechai);
																																																 foreach($respuesta as $row => $item){

																                                                   if ($item['Tipo']=="Ingreso")
																                                                 {$neto=$neto+$item['Monto'];}
																                                               else {$neto=$neto-$item['Monto'];}
