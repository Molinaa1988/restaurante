			                 ...
			                 <div class="col-md-12">
			                     ...
			                     <div class="panel panel-primary">
			                         <div class="panel-heading">
			                             Reporte cuentas por cobrar pendientes
			                         </div>
			                                      ...
			                                      <tr>
			                                       ...
			                                       <hr/>
			                                           <div style="font-size: 14px;"align="center">
			                                              <strong>Reporte cuentas por cobrar pendientes</strong><br>
			                                         </div>
			                                         <hr/>
			                                     </div>
			                             <div class="table-responsive">
			                                 <table class="table table-striped table-bordered table-hover"  width="100%"  border="0">
																				 ...
																				 <table class="table table-striped table-bordered table-hover"  width="100%"  border="0">
																			                                     <thead>
																			                                         <tr>
																			                                             <th><center>Comprobante</center></th>
																			                                              ...
																			                                              <th><center>Ultimo abono</center></th>
																			                                    ...
																			                                    <?php
																			                                                 $neto=0;
																																											 $respuesta =  controllerReportes::ReporteCuentasporcobrarpendientes();
																																																			 foreach($respuesta as $row => $item){
																			                                                     $neto=$neto+$item['SaldoPendiente'];
																			                                             ?>
																			                                         <tr class="odd gradeX">
																			                                               <td><center><?php echo $item['TipoComprobante'] ?></center></td>
																			                                               ...
																			                                               <td><center>$ <?php echo $item['Monto'] ?></center></td>
																			                                                <td><center><?php echo $item['UltimoAbono'] ?></center></td>
																			                                               <td><center>$ <?php echo $item['SaldoPendiente'] ?></center></td>
																			                                         </tr>
																			                                         <?php } ?>
																			                                          <tr>
																			                                                              <td colspan="5"><div align="right"><strong><h4>Cuentas por cobrar pendientes</h4></strong></div></td>
