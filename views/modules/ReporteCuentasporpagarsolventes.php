			                 ...
			                 <div class="col-md-12">
			                     ...
			                     <div class="panel panel-primary">
			                         <div class="panel-heading">
			                             Reporte cuentas por pagar solventes
			                         </div>
			                          ...
			                          <div id="imprimeme">
			                                      ...
			                                      <tr>
			                                       ...
			                                       <hr/>
			                                           <div style="font-size: 14px;"align="center">
			                                              <strong>Reporte cuentas por pagar solventes</strong><br>
			                                         </div>
			                                         <hr/>
			                                     </div>
			                             <div class="table-responsive">
			                                 <table class="table table-striped table-bordered table-hover"  width="100%"  border="0">
																 ...
																 <?php
																							$neto=0;
																							$respuesta =  controllerReportes::ReporteCuentasporpagarsolventes();
																					 									 foreach($respuesta as $row => $item){
																									$neto=$neto+$item['UltimoAbono'];
																					?>
																			<tr class="odd gradeX">
