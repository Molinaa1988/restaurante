			                 ...
			                 <div class="col-md-12">
			                     ...
			                     <div class="panel panel-primary">
			                         <div class="panel-heading">
			                             Reporte ingresos y egresos por año
			                         </div>
			                                      ...
			                                      <tr>
			                                       ...
			                                       <hr/>
			                                           <div style="font-size: 14px;"align="center">
			                                              <strong>Reporte ingresos y egresos por año</strong><br>
			                                         </div>
			                                         <hr/>
			                                     </div>
																					                                 ...
																					                                 <table class="table table-striped table-bordered table-hover"  width="100%"  border="0">
																					                                    ...
																					                                    <?php
																					                                                 $neto=0;
																																													 ...
																																													 $respuesta =  controllerReportes::ReporteIngresoEgresosporaño1($_fecha1,$_fecha2);
																					                                 ...
																					                                 <table class="table table-striped table-bordered table-hover"  width="100%"  border="0">
																					                                    ...
																					                                    <?php
																					                                                 $neto=0;
																																													 ...
																																													 $respuesta =  controllerReportes::ReporteIngresoEgresosporaño2($_fecha1,$_fecha2);
																																																					 foreach($respuesta as $row => $item){
																					                                                     $neto=$neto+$item['Total'];
																					                                             ?>
																					                                         <tr class="odd gradeX">
