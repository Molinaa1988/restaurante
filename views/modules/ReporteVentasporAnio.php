			 ...
			 ?>
			                 ...
			                 <div class="col-md-12">
			                                      ...
			                                      <tr>
			                                       ...
			                                       <hr/>
			                                           <div style="font-size: 14px;"align="center">
			                                              <strong>Reporte de ventas por año</strong><br>
			                                         </div>
			                                         <hr/>
			                                     </div>
                                ...
                                <?php
                                             ...
                                             $propina=0;
                                             $TotalPagar=0;
                                             $respuesta = controllerReportes::ReporteVentasporAnio($_fecha1,$_fecha2);
                                              foreach($respuesta as $row => $item){
                                                 $neto=$neto+$item['Total'];
                                                 $propina=$propina+$item['Propina'];
                                                 $TotalPagar=$TotalPagar+$item['TotalPagar'];
                                         ?>
                                     <tr class="odd gradeX">
                                         ...
                                         ?>
                                           ...
                                           <td><center>$ <?php echo number_format($item['Propina'], 2) ?></center></td>
                                           <td><center>$ <?php echo number_format($item['TotalPagar'], 2) ?></center></td>
                                     </tr>
                                     <?php } ?>
                                      <tr>
                                                          <td><div align="right"><strong><h4>Total General</h4></strong></div></td>
                                                          <td><div align="center"><strong><h4>$ <?php echo number_format($neto, 2); ?></h4></strong></div></td>
                                                          <td><div align="center"><strong><h4>$ <?php echo number_format($propina, 2); ?></h4></strong></div></td>
                                                          <td><div align="center"><strong><h4>$ <?php echo number_format($TotalPagar, 2); ?></h4></strong></div></td>
