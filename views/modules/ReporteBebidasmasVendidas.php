			                                      ...
			                                      <tr>
			                                       ...
			                                       <hr/>
			                                           <div style="font-size: 14px;"align="center">
			                                              <strong>Reporte bebidas mas vendidas</strong><br>
			                                         </div>
			                                         <hr/>
			                                     </div>
			                             <div class="table-responsive">
			                                 <table class="table table-striped table-bordered table-hover"  width="100%"  border="0">
																				 <thead>
																			                                    ...
																			                                    <?php
																			                                                 $neto=0;
																																											 $respuesta =  controllerReportes::ReporteBebidasmasVendidas($fechai.' 00:00:00',$fechaf.' 23:59:59');
