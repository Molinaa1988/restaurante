			                                     ...
			                                     <tr>
			                                      ...
			                                      <hr/>
			                                          <div style="font-size: 14px;"align="center">
			                                             <strong>Comparacion por año</strong><br>
			                                        </div>
			                                        <hr/>
			                                    </div>
			                             <div class="table-responsive">
			                                 <table class="table table-striped table-bordered table-hover"  width="100%"  border="0">
																				 ...
																				 <thead>
																			                                    ...
																			                                    <?php
																			                                                 $neto=0;
																																			$respuesta = controllerReportes::ReporteComparacionporAnios();
																			
																																												foreach($respuesta as $row => $item){
																			                                                     $neto=$neto+$item['Total'];
																			                                             ?>
																			                                         <tr class="odd gradeX">
																			                                               <td><center><?php echo $item['Anio'] ?></center></td>
